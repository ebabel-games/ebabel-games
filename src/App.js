  ...
  <>
    ...
    <section className='container'>
      ...
      <ContentBlock title='Contact'>
        <p>
          Feel free to call my mobile on <span className='contact'><a href='tel:0031621809899'>+31 (0)6 21 80 98 99</a></span>
        </p>
        <p>
          You can also drop me an e-mail <span className='contact'><a href='mailto:hello@ebabel.eu'>hello@ebabel.eu</a></span>
        </p>
      </ContentBlock>
    </section>
    <Footer />
